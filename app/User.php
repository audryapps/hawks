 ...
 * @property string|null $trail_end_at
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User whereTrailEndAt($value)
...
class User extends Authenticatable
{
    ...
    public function student(){
        return $this->hasOne(related:Stundent::class);
    }
    public function teacher(){
        return $this ->hasOne(related:Teacher::class);
    }
    public function socialAccount(){
        return $this->hasOne(realated:UserSocialAccount::class);
    }
}
